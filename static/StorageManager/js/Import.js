...
async function fetchInventory() {
  try {
    const res = await fetch("/static/StorageManager/json/TestData.json");
...
// DOMContentLoaded – wire up all event listeners and init flow
